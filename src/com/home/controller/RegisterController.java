		...
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				...
				btnNewButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						...
						Boolean result = loginService.register(textField.getText(),passwordField.getText());
						if (result) {
							JOptionPane.showMessageDialog(null, "恭喜你，注册成功！！！");  
						}else {
							System.out.println("登录失败，请重新登陆！！！");
							JOptionPane.showMessageDialog(null, "注册失败，请检查后重试！！！");  
						}
				...
				btnNewButton.setBounds(159, 208, 93, 23);
