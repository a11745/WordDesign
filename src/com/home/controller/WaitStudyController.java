...
public class WaitStudyController extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WaitStudyController frame = new WaitStudyController(null);
	 ...
	 * Create the frame.
	 */
	public WaitStudyController(User user) {
		//设置标题
		super("待学单词");
		...
		List<Words> list = wordService.achieve(user.getId(),0);
