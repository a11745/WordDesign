...
public class EditWordController extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditWordController frame = new EditWordController(null,null,null,null,null);
	 ...
	 * Create the frame.
	 */
	public EditWordController(User user,Integer id,String wordname,String quality,String chinese) {
		//设置标题
		super("修改单词");
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Boolean result = wordService.editWord(id,textField.getText(), textField_1.getText(),user.getId(),textField_2.getText());
				if (result) {
					JOptionPane.showMessageDialog(null, "修改成功！！！"); 
					
				}else {
					JOptionPane.showMessageDialog(null, "修改失败，请检查后重试！！！"); 
				}
